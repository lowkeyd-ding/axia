...
const FUND_DATA: SymbolInfo[] = [
  ...
  { symbol: '508091', name: '华夏凯德消费REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508017', name: '华夏华润商业REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508055', name: '华夏北京保障房REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508028', name: '东吴苏州工业园REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508009', name: '中金安徽交控REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508029', name: '华安深圳安居REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508018', name: '华夏江苏交控REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508019', name: '华夏杭州和达REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508020', name: '华夏南京燕子矶REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508022', name: '国君东久REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508023', name: '国君临港东久REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508025', name: '博时江苏交控REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508026', name: '中金湖北交投REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508033', name: '华安张江REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508036', name: '华泰江苏高速REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508039', name: '中金山东高速REIT', assetType: 'fund', exchange: 'SH' },
  { symbol: '508046', name: '华夏北京光环新网REIT', assetType: 'fund', exchange: 'SH' },
