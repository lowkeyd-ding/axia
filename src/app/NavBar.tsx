          ...
          <div className="flex items-center gap-1">
            ...
            <div className="ml-2 pl-2 border-l border-zinc-200" ref={dropdownRef}>
              {isLoading ? (
                ...
                <Link href="/auth/login" className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-zinc-600 hover:text-zinc-900 hover:bg-zinc-100 transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
